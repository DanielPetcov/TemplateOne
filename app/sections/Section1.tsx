...
export default function Section1({
  ...
  return (
    <div className="container mx-auto bg-custom-main px-2">
      <div className="flex flex-col gap-10 items-center justify-center">
        <div>
          <div className="max-w-sm md:max-w-md relative">
            ...
            <img
              src={flower_1.src}
              className="w-40 absolute top-10 left-10 -translate-1/2 z-1"
            />
            <img
              src={leafe_2.src}
              className="w-20 absolute top-5 left-20 -translate-y-1/2 rotate-90 z-0"
            />
          </div>
        </div>
